    ...
    describe("Provide", () => {
        it("Provides automatically named property", async () => {
            ...
            @Component({
                ...
                @Provide @Data public test: string = "A";
            };
        ...
        it("Provides automatically named property from factory", async () => {
            ...
            @Component({
                ...
                @Provide() @Data public test: string = "B";
            };
        ...
        it("Provides manually named property from factory", async () => {
            ...
            @Component({
                ...
                @Provide("field") @Data public test: string = "C";
            };
            ...
            @Component({
                ...
                @Provide("field1") @Data public test: number = 10;
                @Provide @Data public field2: number = 1;
            };

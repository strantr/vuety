...
function default_1() {
    describe("Component", function () {
        it("Should create new Vue element", function () {
            ...
            chai_1.expect(new A()).instanceof(Vue);
        });
        it("Passes options", function () {
            ...
            chai_1.expect(new A().$options.template).to.equal(template);
        });
    });
}
...
function default_1() {
    ...
    describe("Data", function () {
        it("Should be empty by default", function () {
            ...
            chai_1.expect(new A()["$data"]).to.eql({});
        });
        ...
        it("Allows default value via factory", function () {
            var A = (function (_super) {
                __extends(A, _super);
                function A() {
                    return _super !== null && _super.apply(this, arguments) || this;
        ...
        it("Allows default value via field value", function () {
            var A = (function (_super) {
                __extends(A, _super);
                function A() {
        ...
        it("Factory default overrides field default", function () {
            var A = (function (_super) {
                __extends(A, _super);
                function A() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
        ...
        it("Can be assigned to", function () {
            ...
            var a = new A();
            a.test = "e";
            chai_1.expect(a.test).to.eql("e");
        });
        it("Can be used for binding", function () { return __awaiter(_this, void 0, void 0, function () {
            var A, a;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        a = new A().$mount(document.createElement("div"));
                        chai_1.expect(a.$el.outerHTML).to.eql("<div>c</div>");
                        a.test = "d";
                        return [4 /*yield*/, a.$nextTick()];
                    case 1:
                        _a.sent();
                        chai_1.expect(a.$el.outerHTML).to.eql("<div>d</div>");
                        return [2 /*return*/];
                }
            });
        }); });
...
function default_1() {
    describe("Lifecycle", function () {
        it("Should populate options", function () {
            ...
            chai_1.expect(new A().$options).to.not.have.property("beforeCreate");
            var B = (function (_super) {
                __extends(B, _super);
                function B() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                B.prototype.beforeCreate = function () {
                };
                return B;
            }(Vue));
            __decorate([
                src_1.Lifecycle
            ], B.prototype, "beforeCreate", null);
            B = __decorate([
                src_1.Component()
            ], B);
            ;
            chai_1.expect(new B().$options).to.have.property("beforeCreate");
        });
        it("Should be called via lifecycle events", function () {
            var A = (function (_super) {
                __extends(A, _super);
                function A() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                A.prototype.beforeCreate = function () {
                    this.field = (this.field || "") + "a";
                };
                A.prototype.created = function () {
                    this.field = (this.field || "") + "b";
                };
                A.prototype.beforeMount = function () {
            ...
            __decorate([
                src_1.Lifecycle
            ], A.prototype, "beforeCreate", null);
            __decorate([
                src_1.Lifecycle
            ], A.prototype, "created", null);
            __decorate([
                src_1.Lifecycle
            ], A.prototype, "beforeMount", null);
            __decorate([
                src_1.Lifecycle
            ], A.prototype, "mounted", null);
            A = __decorate([
                src_1.Component({
                    template: "<div/>"
                })
            ...
            var a = new A();
            chai_1.expect(a.field).to.equal("ab");
            var el = document.createElement("div");
            a.$mount(el);
            chai_1.expect(a.field).to.equal("abcd");
        });
    });
}
exports.default = default_1;
...
function default_1() {
    ...
    describe("Prop", function () {
        it("Should be empty by default", function () {
            ...
            chai_1.expect(new A()["$props"]).to.eql(undefined);
        });
        it("Populates options", function () {
            var A = (function (_super) {
                __extends(A, _super);
            ...
            chai_1.expect(new A()["$props"]).to.eql({
                test: undefined
            });
        });
        it("Allows default value via PropOpts", function () {
            var A = (function (_super) {
                __extends(A, _super);
                function A() {
                    return _super !== null && _super.apply(this, arguments) || this;
            ...
            __decorate([
                src_1.Prop({ default: "a" })
            ], A.prototype, "test", void 0);
            A = __decorate([
                src_1.Component()
            ], A);
            chai_1.expect(new A().test).to.eql("a");
        });
        it("Allows default value via PropOpts factory", function () {
            var A = (function (_super) {
                __extends(A, _super);
                function A() {
                    return _super !== null && _super.apply(this, arguments) || this;
            ...
            __decorate([
                src_1.Prop({ default: function () { return "a"; } })
            ], A.prototype, "test", void 0);
            A = __decorate([
                src_1.Component()
            ], A);
        ...
        it("Allows default value via field value", function () {
            ...
            chai_1.expect(new A().test).to.eql("b");
        });
        it("PropOpts overrides field default", function () {
            var A = (function (_super) {
                __extends(A, _super);
                function A() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
            ...
            chai_1.expect(new A().test).to.eql("d");
        });
        it("Factory default overrides field default", function () {
            var A = (function (_super) {
                __extends(A, _super);
        ...
        it("Can be passed in", function () { return __awaiter(_this, void 0, void 0, function () {
            var Child, A, a;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        ;
                        a = new A().$mount(document.createElement("div"));
                        chai_1.expect(a.$el.outerHTML).to.eql("<div><span>hello</span></div>");
                        a.test = "d";
                        return [4 /*yield*/, a.$nextTick()];
                    case 1:
                        _a.sent();
                        chai_1.expect(a.$el.outerHTML).to.eql("<div><span>d</span></div>");
                        return [2 /*return*/];
                }
            });
        }); });
...
function default_1() {
    ...
    describe("Render", function () {
        it("Can render", function () { return __awaiter(_this, void 0, void 0, function () {
            var A, a;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        __decorate([
                            src_1.Render
                        ], A.prototype, "render", null);
                        A = __decorate([
                            src_1.Component()
                        ], A);
                        ;
                        a = new A().$mount(document.createElement("div"));
                        chai_1.expect(a.$el.outerHTML).to.eql("<div>a</div>");
                        a.test = "d";
                        return [4 /*yield*/, a.$nextTick()];
                    case 1:
                        _a.sent();
...
function default_1() {
    ...
    describe("Watch", function () {
        it("Can watch props", function () { return __awaiter(_this, void 0, void 0, function () {
            var result, Child, A, a;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = "";
                        Child = (function (_super) {
                            ...
                            Child.prototype.pChanged = function (value, oldValue) {
                    ...
                    case 1:
                        _a.sent();
                        chai_1.expect(result).to.eql("d,hello,");
                        return [2 /*return*/];
                }
            });
        }); });
        it("Can watch data", function () { return __awaiter(_this, void 0, void 0, function () {
            var result, A, a;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        A = (function (_super) {
                            ...
                            A.prototype.testChanged = function (value, oldValue) {
                                result += value + "," + oldValue + ",";
                            };
                            return A;
                        }(Vue));
...
Object.defineProperty(exports, "__esModule", { value: true });
var defaultStore = new Map();
function Component(options) {
    var opts = options || {};
    return function (target) {
        var proto = target.prototype;
        var instance;
        var vuety = proto.$vuety;
        if (vuety) {
            var getDefault = function (key) {
                var store = defaultStore.get(target);
                if (store == null) {
                    store = {};
            ...
            var keys = Object.keys(vuety);
            var data_1 = undefined;
            for (var i = 0; i < keys.length; i++) {
                var callbacks = vuety[keys[i]];
                for (var j = 0; j < callbacks.length; j++) {
                    callbacks[j]({
                        options: opts,
                        getDefault: getDefault,
                        storeData: function (key, factory) {
                            if (!data_1)
                                data_1 = {};
                            data_1[key] = factory;
                        },
            ...
            if (data_1) {
                ...
                opts.data = function () {
                    var r = {};
                    Object.keys(_data_1).forEach(function (k) {
                        r[k] = _data_1[k]();
                    });
                    return r;
                };
...
function Data() {
    function data(factory, target, propertyKey) {
        core_1.Vuety("Data", target)(function (v) {
            if (!factory) {
...
function Lifecycle() {
    function lifecycle(target, propertyKey, descriptor) {
        core_1.Vuety("Lifecycle", target)(function (v) {
...
var core_1 = __webpack_require__(3);
function Prop() {
    function prop(options, target, propertyKey) {
        core_1.Vuety("Prop", target)(function (v) {
            if (!options) {
                options = {};
            }
            if (!options.default) {
            ...
            if (!options.type && options.default) {
                ...
                else if (process.env.NODE_ENV !== "production" && Prop.warn) {
                    console.warn("Prop type of a function cannot be automatically determined, set the type member of the property options.");
                }
            }
            var props = {};
    ...
    if (arguments.length === 1) {
        var args_1 = arguments;
        return function () {
            prop.apply(this, [args_1[0]].concat(Array.from(arguments)));
        };
    }
    else {
        prop.apply(this, [undefined].concat(Array.from(arguments)));
    }
    return;
}
exports.Prop = Prop;
...
var core_1 = __webpack_require__(3);
function Render() {
    function render(target, propertyKey, descriptor) {
        core_1.Vuety("Render", target)(function (v) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(3);
function Watch(prop, options) {
    return function (target, propertyKey, descriptor) {
        core_1.Vuety("Watch", target)(function (v) {
            if (!options) {
                options = {};
            }
            var original = descriptor.value;
            descriptor.value = function () {
                original.apply(this, Array.from(arguments).concat([prop]));
            };
            options["handler"] = descriptor.value;
            var watches = {};
            watches[prop] = options;
...
var lifecycle_1 = __webpack_require__(18);
var prop_1 = __webpack_require__(19);
